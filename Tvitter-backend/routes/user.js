...
const { register, login, followUser, logout, updatePassword, updateProfile, deleteProfile, myProfile, viewProfile, forgotPassword, resetPassword } = require('../controllers/user');
